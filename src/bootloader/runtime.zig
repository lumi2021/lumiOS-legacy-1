...
pub const RuntimeServices = extern struct {
    ...
    getTime: *const fn (*Time, ?*TimeCapabilities) callconv(.C) Status,
    ...
    setVirtualAddressMap: *const fn (usize, usize, u32, [*]MemoryDescriptor) callconv(.C) Status,

    /// Determines the new virtual address that is to be used on subsequent memory accesses.
    convertPointer: *const fn (usize, **void) callconv(.C) Status,

    /// Returns the value of a variable.
    getVariable: *const fn ([*:0]const u16, *align(8) const Guid, ?*u32, *usize, ?*void) callconv(.C) Status,

    /// Enumerates the current variable names.
    getNextVariableName: *const fn (*usize, [*:0]u16, *align(8) Guid) callconv(.C) Status,

    /// Sets the value of a variable.
    setVariable: *const fn ([*:0]const u16, *align(8) const Guid, u32, usize, *void) callconv(.C) Status,

    getNextHighMonotonicCount: Status, // TODO

    /// Resets the entire platform.
    resetSystem: *const fn (ResetType, Status, usize, ?*const void) callconv(.C) noreturn,
